...
export const FRAMEWORKS: Framework[] = [
  ...
  // ── DIFFICULT CONVERSATIONS ─────────────────────────────────────────────
  {
    ...
    steps: [
      { title: "B — Break the Pattern", body: "Acknowledge the tension upfront — name it before you explain it: 'I want to talk about something that's been sitting with me.'" },
      { title: "R — Reason", body: "State clearly why you're bringing it up — your reason, not an accusation." },
      { title: "A — Ask First", body: "Before stating your position, ask what they think or how they experienced it — their answer changes everything." },
      { title: "V — Validate", body: "Their perspective before you respond, even if you disagree: 'I can see why that landed that way.'" },
      { title: "E — End with Action", body: "Close with a concrete next step — what changes, what you both agree to — don't leave it floating." },
      {
        title: "Reading their response",
        body: "GREEN: They engage, share their perspective, tone softens after the B step — keep going.\nYELLOW: They go quiet or seem guarded — slow down, lean into A (ask first), don't push your position yet.\nRED: They shut down, get defensive, or escalate — pause, validate first ('I'm not here to attack you — I genuinely want to understand'), don't proceed to E until you're back in YELLOW or GREEN.",
      },
    ],
    science: "Confrontation avoidance is maintained by anticipated pain — the brain predicts the conversation will go worse than it does. Naming the tension in the B step defuses it before it escalates, because the other person's threat response fires on mystery and unspoken conflict far more than on direct acknowledgment.",
    ...
    keyPoint: "The Break step is what most people skip. Naming the tension upfront changes the entire dynamic — it signals that you're in control of the moment, not the anxiety.",
  },
  ...
  // ── DIFFICULT PEOPLE ─────────────────────────────────────────────────────
  {
    ...
    steps: [
      { title: "S — See It Coming", body: "Recognize the pattern — once you've named it, you can't unsee it. Name it out loud to yourself: 'There it is.'" },
      { title: "H — Hold Your Frame", body: "Your emotional state is yours — don't let their behavior decide how you feel. Pre-commit: 'I will not react.'" },
      { title: "I — Isolate the Behavior", body: "Name what's happening without attacking the person: 'when you say it like that, I shut down' not 'you always do this'." },
      { title: "E — Exit or Engage", body: "Engage if the relationship matters AND you have the energy AND it's a pattern worth addressing — use BRAVE for that conversation. Exit if the relationship has no leverage, your battery is RED, or engaging will escalate not resolve. 'I need to step away from this conversation right now' is a complete sentence.\n\nGREEN: Capacity and relationship value both present — engage using I step, move toward BRAVE if recurring.\nYELLOW: Tension elevated, losing your frame — use H first, then I, defer E.\nRED: Being pulled into a reaction or situation escalating — exit immediately, no explanation needed." },
      { title: "L — Log It", body: "Track patterns over time — what triggers them, what escalates it, what de-escalates it. Patterns become predictable, predictable becomes manageable." },
      { title: "D — Detach from Outcome", body: "Control your response, not theirs — their reaction is not your responsibility." },
    ],
    science: "Reactivity is the result of the amygdala hijack — the emotional brain fires before the rational brain can respond. The H step (Hold your frame) is a pre-committed response pattern that prevents the hijack. Once you've named the pattern (S step), the prefrontal cortex stays online.",
    ...
    keyPoint: "The moment you react emotionally, you've handed them control. The power move is not reacting. Every time.",
  },
